...
export default function MobileServiceVideo({ src }: Props) {
        ...
        <>
            ...
            >
                <video
                    ...
                    loop
                    muted
                    className="w-[500px] md:w-[430px] h-[180px] object-cover rounded-lg transform transition duration-500 group-hover:scale-105"
                />
