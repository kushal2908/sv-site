...
export default function AnimatedCard({ height, title, description, url, isLargeContent }: Props) {
    ...
    return (
        <a href={url} target="_blank" rel="noopener noreferrer" className="w-full">
            ...
            >
                ...
                <motion.div
                    variants={{
                        ...
                        hover: {
                            scale: 1,
                            x: -35,
                            y: isLargeContent ? (isDesktopOrLaptop ? 180 : isTablet ? 200 : 320) : 240,
                            bottom: 'auto',
                ...
                >
                    <div className="text-white text-[16px] tracking-tight">{description}</div>
                </motion.div>
            </motion.div>
        </a>
    );
