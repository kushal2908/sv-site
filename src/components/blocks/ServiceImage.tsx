    ...
    <>
      ...
      >
        <Image
          ...
          width={1920}
          height={200}
          className="w-[500px] md:w-[500px] h-[200px] object-cover rounded-lg transform transition duration-500 group-hover:scale-105"
        />
        <div className="absolute inset-0 bg-[#401444]/30 transition group-hover:bg-[#401444]/10" />
      </div>
      {/* Modal */}
      <AnimatePresence>
        {open && (
