...
export default function AnimatedCard({ height, title, description, url, isLarge }: Props) {
    ...
    return (
        <a href={url} target="_blank" rel="noopener noreferrer" className="w-full">
            ...
            >
                ...
                >
                    <div className="text-white text-[17px] tracking-tight font-medium">{description}</div>
                </motion.div>
            </motion.div>
        </a>
    );
