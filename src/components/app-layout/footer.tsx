...
export default function Footer() {
    return (
        <footer className="flex justify-center items-center py-14 px-4 bg-gradient-to-b from-[#551b5e] to-[#401444] text-white">
            <div className="max-w-[1200px] grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="text-center border-0 md:border-r border-gray-100 mb-14 md:mb-0">
                    ...
                    <div className="flex items-center justify-center gap-4 mt-4">
                        {/* Instagram */}
                        <Link href="https://www.instagram.com/skillventures.sv?igsh=M3BwMGJlN2JtbHNt" target="_blank">
                            <svg
                        ...
                        {/* Facebook */}
                        <Link href="https://www.facebook.com/share/162M9BS4Bq/" target="_blank">
                            <svg
...
const LocationBlock = () => {
    return (
        <div className="">
            ...
            <Tooltip id="bangladesh-tooltip" style={{ backgroundColor: 'rgba(255,255,255,1)' }}>
                <div className="text-black tracking-tight text-[13px]">
                    <p>House#112</p>
                    <p>Road#06</p>
                    <p>Mohakhali DOHS</p>
            ...
            <Tooltip id="singapore-tooltip" style={{ backgroundColor: 'rgba(255,255,255,1)' }}>
                <div className="text-black tracking-tight text-[13px]">
            ...
            <Tooltip id="uae-tooltip" style={{ backgroundColor: 'rgba(255,255,255,1)' }}>
                <div className="text-black tracking-tight text-[13px]">
                    <p>Business Center</p>
            ...
            <Tooltip id="usa-tooltip" style={{ backgroundColor: 'rgba(255,255,255,1)' }}>
                <div className="text-black tracking-tight text-[13px]">
                    <p>2248 Broadway,</p>
                    <p>#1619 NY 10024,</p>
                    <p>New York</p>
